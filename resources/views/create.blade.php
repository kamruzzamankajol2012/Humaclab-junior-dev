...
<div class="container">
	<div class="row">
        ...
        <div class="col-md-8">
          <h2 class="display-4 text-center">Rod</h2>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Price" name="prices">
